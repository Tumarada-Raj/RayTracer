...
void renderBlurredSphere(float scale, const char* filename, Camera* cam, int numSamples = 1) {
    ...
    Material* flatMaterial1 = new FlatMaterial(redtex);
    Material* flatMaterial2 = new FlatMaterial(yellowtex);
...
void a_distributed() {
    ...
    renderBlurredSphere(0.001f, "MotionBlur.png", motionblurcam, 15);
}