...
void renderCornellboxC(float scale, const char* filename) {
    ...
    //projective light
    world.light.push_back(new ProjectiveLight(Point(290 * scale, 329.99f * scale, 279.5f * scale), RGBColor(0, 0, 1.0f)));
    world.light.push_back(new ProjectiveLight(Point(490 * scale, 329.99f * scale, 279.5f * scale), RGBColor(1.0f, 0, 0)));
    world.light.push_back(new ProjectiveLight(Point(150 * scale, 329.99f * scale, 279.5f * scale), RGBColor(0, 1.0f, 0)));
    RayTracingIntegrator integrator(&world);
